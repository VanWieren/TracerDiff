...
(https://doi.org/10.1016/j.epsl.2025.119745). The companion analysis
repository with the notebooks used to produce the paper's figures is at
https://github.com/VanWieren/Paleozoic_CIEs.
